...
export default function Footer() {
  return (
    <footer className="bg-foreground border-t border-primary/20 mt-40">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div>
            <h3 className="text-base font-semibold uppercase tracking-[0.15em] mb-8 text-background">Contact Info</h3>
